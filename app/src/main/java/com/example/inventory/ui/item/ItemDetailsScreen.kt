...
fun ItemDetailsScreen(
    ...
    Scaffold(
        ...
        ItemDetailsBody(
            ...
            onShareItem = { coroutineScope.launch {
                viewModel.shareItem()
            }},
...
fun ItemDetails(
    ...
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                labelResID = R.string.sup_name,
                itemDetail = item.supName,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(id = R.dimen.padding_medium)
                )
            )
            ItemDetailsRow(
                ...
                itemDetail = if (!Settings.hideSensitiveData  || item.email == "") item.email else "*******",
                modifier = Modifier.padding(
                    horizontal = dimensionResource(id = R.dimen.padding_medium)
                )
            )
            ItemDetailsRow(
                ...
                itemDetail = if (!Settings.hideSensitiveData || item.phone == "") item.phone else "*******",
                modifier = Modifier.padding(
                    horizontal = dimensionResource(id = R.dimen.padding_medium)
                )
            )
